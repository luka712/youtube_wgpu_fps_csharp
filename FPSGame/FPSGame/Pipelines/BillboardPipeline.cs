...
public unsafe class BillboardRenderPipeline : IDisposable
{
    ...
    private void CreateBindGroupLayouts()
    {
        ...
        modelBindGroupLayoutDesc.Label = "Billboard Render Pipeline Transform Bind Group Layout".ToBytePtr();
    ...
    private void CreateTextureBindGroup()
    {
        ...
        {
            Label = (byte*)Marshal.StringToHGlobalAnsi("Billboard Render Pipeline Texture Bind Group"),
